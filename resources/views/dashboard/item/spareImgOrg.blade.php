...
@section('content')
    ...
    <div class="col-lg-12 mb-5">
        ...
        <div class="form-group clearfix">
            ...
            <fieldset class="mb-4 form-group">
                <label>配送区分</label>
                <select class="form-control col-md-6{{ $errors->has('cate_id') ? ' is-invalid' : '' }}" name="dg_id">
                    <option disabled selected>選択して下さい</option>
                    @foreach($dgs as $dg)
                        <?php
                            $selected = '';
            ...
            <fieldset class="mb-3 form-group">
                <label for="stock" class="control-label">ポイント還元率</label>
                <input class="form-control col-md-6{{ $errors->has('point_back') ? ' is-invalid' : '' }}" name="stock" value="{{ Ctm::isOld() ? old('point_back') : (isset($item) ? $item->point_back : '') }}">
            ...
            <fieldset class="mb-5 form-group{{ $errors->has('about_ship') ? ' is-invalid' : '' }}">
            ...
            <div class="clearfix mb-3">
                ...
                <div class="clearfix thumb-wrap">
                    ...
                    <div class="col-md-8 pull-left text-left form-group{{ $errors->has('snap_thumb.'.$n) ? ' has-error' : '' }}">
                        <label for="model_thumb" class="col-md-12 text-left">情報画像</label>
                        <div class="col-md-12">
